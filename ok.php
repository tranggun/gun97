...
$idstt= $curllike[1];  
if($sllike <= $limitlike){
login("http://www.autolikesgroups.com/login.php?user=".$token."","null");
echo post_data("http://www.autolikesgroups.com/home.php?type=custom","id=".$idstt."&submit=Submit&selector=400");
}
?>